...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/laravel-dbdic/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/laravel-dbdic/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/laravel-dbdic/css/dbdic.css') }}">
    <link rel="stylesheet" href="{{ asset('vendor/laravel-dbdic/css/animate.min.css') }}">
</head>
<body>
<div id="wrapper">
    <!-- Sidebar -->
        ...
        <div class="export-wrap">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a href="{{ route('dbdic.export','html') }}"><i class="fa fa-file-zip-o"></i> Html</a></li>
                    <li><a href="{{ route('dbdic.export','pdf') }}"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
                    <li><a href="{{ route('dbdic.export','md') }}"><i class="fa fa-file-pdf-o"></i> Markdown</a></li>
    ...
    <footer>
        <div id="auth">
            <a href="{{ config('laravel-dbdic.copyright.link') }}" target="_blank">{{ config('laravel-dbdic.copyright.text') }}</a>
        </div>
    </footer>
</div>

<script src="{{ asset('vendor/laravel-dbdic/js/jquery.min.js') }}"></script>
<script src="{{ asset('vendor/laravel-dbdic/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('vendor/laravel-dbdic/js/dbdic.js') }}"></script>
</body>
</html>
